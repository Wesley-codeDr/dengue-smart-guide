...
const Header = () => {
  ...
  return (
    <motion.header
      className="modern-hero min-h-[90vh] flex items-center justify-center relative overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div className="modern-blob top-[-10%] left-[5%] opacity-70 animate-float"></div>
        <div className="modern-blob bottom-[-5%] right-[15%] opacity-50 animate-float-delayed"></div>
      </div>
      
      <div className="modern-container relative z-10 px-6">
        <motion.div
